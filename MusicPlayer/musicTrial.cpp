...
const string EXPECTED_HEADER = "Title,Artist,Genre,Year,Duration,FilePath";
...
{
public:
    string title, artist, genre, duration, filepath;
    int year;
    Song() { year = 0; }

    Song(string t, string a, string g, int y, string d, string f)
    {
        title = t;
        artist = a;
        genre = g;
